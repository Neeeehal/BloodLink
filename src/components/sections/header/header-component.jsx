...
import WhiteLogo from "../../../../public/BloodWhite.png";
import BlackLogo from "../../../../public/BloodBlack.png";
...
const compnayName = "BloodLink Blood Bank";
			...
			>
				...
				<div className="flex lg:flex-1">
					<a href="/" className="-m-1.0 p-1.0">
						...
						<img className="w-auto h-20" src={WhiteLogo} alt="" />
					</a>
				</div>
